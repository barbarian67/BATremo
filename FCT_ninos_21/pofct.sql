...
insert into PROFESORES (idPro,nomPro,DNI,MensajeDefault,CICLO,mailPro) values (3,'Rafael Velarde','43764380L','Hola, muy buenas todos, aqui Willyrex comentando',3,'rafael@iesfernandoaguilar.es');
insert into PROFESORES (idPro,nomPro,DNI,MensajeDefault,CICLO,mailPro) values (4,'Diego Vegas','87657583D','Hola, muy buenas todos, aqui Willyrex comentando',4,'diego@iesfernandoaguilar.es');
...
insert into CONTACTOS (idCont,FCont,Mensaje,RESPUESTA,Medio,profesor) values (2,'05-12-21','Pues en función del perfil',1,2,2);
insert into CONTACTOS (idCont,FCont,Mensaje,RESPUESTA,Medio,profesor) values (3,'22-11-21','Le adjunto el currículo genérico de los administradores que formamos',2,2,2);
insert into CONTACTOS (idCont,FCont,Mensaje,RESPUESTA,Medio,profesor) values (4,'10-01-22','Hola, ¿Estarían interesados en repetir la experiencia de prácticas con nosotros?. Gracias',null,2,4);
insert into CONTACTOS (idCont,FCont,Mensaje,RESPUESTA,Medio,profesor) values (5,'16-01-22','Aún no lo sabemos le contesto en unas semanas',4,2,4);
...
insert into COMUNICACIONES (PERSONA,CONTACTO) values (4,1);
insert into COMUNICACIONES (PERSONA,CONTACTO) values (4,2);
insert into COMUNICACIONES (PERSONA,CONTACTO) values (4,3);
insert into COMUNICACIONES (PERSONA,CONTACTO) values (1,4);
insert into COMUNICACIONES (PERSONA,CONTACTO) values (1,5);
